...
function Videopost() {
    ...
    return (
        <>
            ...
            <div className="card  shadow-xss rounded-xxl p-1 p-md-4  mb-3"
                style={{ border: "none" }}>
                                    ...
                                    <div className="video-player" ref={videoContainerRef}>
                                        ...
                                        <div className="controls">
                                            ...
                                            <button onClick={() => handleVolumeChange({ target: { value: volume > 0 ? 0 : 1 } })}>
                                                {volume > 0 ? <img src={volumeup} alt="" /> : <FaVolumeMute />}
                                            </button>
                                            <button onClick={() => console.log("Settings button clicked")}>
                                                <img src={setting} alt="" />
                                            </button>
                                            <button onClick={handleFullScreen}>{isFullScreen ? <FaExpand /> : <img src={full} alt="" />}</button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div
                    className="card-body d-flex gap-4 pt-3 mt-3 border-top-xs border-bottom-xs justify-content-xxl-around"
                >
                    <div className="emoji-bttn d-flex align-items-center fw-400 lh-26 font-lg ms-2"
                        style={{ color: "#5B7083" }}>
                        <img src={comment} alt="" style={{ width: "34px", marginRight: "5px" }} />   61
                    </div>
                    <div className="emoji-bttn d-flex align-items-center fw-400 lh-26 font-lg ms-2"
                        style={{ color: "#F4245E" }}>
                        <img src={redheart} alt="" style={{ width: "34px", marginRight: "5px" }} />   6.2K
                    </div> <div className="emoji-bttn d-flex align-items-center fw-400 lh-26 font-lg ms-2"
                        style={{ color: "#5B7083" }}>
                        <img src={share} alt="" style={{ width: "34px", marginRight: "5px" }} />   61
                    </div>
