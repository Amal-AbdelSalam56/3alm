...
const CommentModal = ({ open, handleClose, comments, addComment }) => {
    ...
    const handleLikeReply = (commentIndex, replyIndex) => {
        const updatedComments = [...comments];
        const currentLikes = updatedComments[commentIndex].replies[replyIndex].likes;
        ...
        if (updatedComments[commentIndex].replies[replyIndex].src === redheart) {
            ...
            updatedComments[commentIndex].replies[replyIndex].likes = currentLikes - 1;
        } else {
    ...
    return (
        <>
            ...
            >
                <Box sx={{
                    position: "absolute", top: "70%", left: "50%", height: "62%", bottom: "0", textAlign: "center", overflow: "auto",
                    transform: "translate(-50%, -50%)", width: "28.5rem", bgcolor: "#F5F5F4", border: "2px solid #000", p: 2, borderRadius: "10px"
                }}>
                    <img src={xicon} alt="" style={{ float: "right", cursor: "pointer" }}
                        onClick={handleClose} />
                    <h2 id="modal-modal-title">  {comments.length} <span>Comments</span> </h2>
                    {comments.map((comment, index) => (
                        <Box key={index} mb={2} borderBottom="1px solid #ccc">
                            <Box display="flex" alignItems="end" className="justify-between" >
                                <div className="justify-between flex">
                                    <img src={Picture} alt="User Photo" width={30} height={30} style={{ borderRadius: "50%", marginRight: "8px" }} />
                            ...
                            <Box display="flex" alignItems="end" className="justify-between mt-1 ml-7" >
                                <div className="justify-between flex">
                                    <Typography variant="body2" style={{ fontSize: "17", fontWeight: "600", color: "#011627" }} color="text.secondary" mb={1}>
                                        {comment.comment}
                                    </Typography>
                            ...
                            <Box display="flex" alignItems="end" className="justify-between ml-5" >
                                    ...
                                    <Box>
                                        {comment.replies.map((reply, replyIndex) => (
                                            <div key={replyIndex}>
                                                <Box display="flex" alignItems="end" className="justify-between" >
                                                    <div className="justify-between flex">
                                                        <img src={Picture} alt="User Photo" width={30} height={30}
                                                            style={{ borderRadius: "50%", marginRight: "8px" }} />
                                                        <Typography variant="body1" style={{ color: "#86878B", }}>
                                                            martini_rond
                                                        </Typography>
                                                    </div>
                                                    <IconButton onClick={() => handleLikeReply(index, replyIndex)}>
                                                        <img
                                                ...
                                                <Box display="flex" alignItems="end" className="justify-between mt-1 ml-7" >
                                                    <div className="justify-between flex">
                                                        <Typography variant="body2" style={{ fontSize: "17", fontWeight: "600", color: "#011627" }}
                    ...
                    <div
                        ...
                        <img src={ASign} alt="Calendar Icon" width={20} height={20} style={{ marginRight: '8px' }} />

                        {/* show Emoji */}
                        <img src={Emoji} alt="Heart Icon" width={20} height={20} style={{ marginRight: '8px' }}
                            onClick={() => setShowEmojiPicker((val) => !val)} />


                        <input
                            type="text" style={{
                                flex: 1, outline: 'none', border: 'none', overflow: 'auto',
